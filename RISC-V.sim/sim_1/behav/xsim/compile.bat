...
REM
REM Generated by Vivado on Sun Jan 04 17:47:38 +0530 2026
...
echo "xvlog --incr --relax -prj tb_riscv_soc_vlog.prj"
call xvlog  --incr --relax -prj tb_riscv_soc_vlog.prj -log xvlog.log
